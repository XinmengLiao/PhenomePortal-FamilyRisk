...
if(cohort == "family"){
  ...
  write.table(df, paste0(output_dir, "/Results/cohort_PGS.txt"), sep = "\t", row.names = FALSE, quote = FALSE)
  ...
  ggsave(p1, filename = paste0(output_dir, "/Results/PGS_Znorm1_DensityPlot.png"), width = 8, height = 6, dpi = 300)
  ggsave(p2, filename = paste0(output_dir, "/Results/PGS_Znorm2_DensityPlot.png"), width = 8, height = 6, dpi = 300)
