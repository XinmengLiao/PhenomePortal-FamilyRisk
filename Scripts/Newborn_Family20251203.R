...
output_dir = "/Users/xinmengliao/Documents/Project/20250710_NewbornRisk/rwgs/Results20251204"
genelist <- c("TR","BabySeq")
...
write.table(positive.res, paste0(output_dir, "/monogenic_positive_results.txt"), sep = "\t", row.names = FALSE, quote = FALSE)
write.table(carrier.res, paste0(output_dir, "/carrier_status_results.txt"), sep = "\t", row.names = FALSE, quote = FALSE)
