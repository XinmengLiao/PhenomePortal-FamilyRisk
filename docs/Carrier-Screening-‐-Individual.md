## 🔹 Individual-level Carrier Screening 

### 1. Upload genomic data and set configurations
- From the **Home** page, choose **“Carrier Screening - Individual”**. Click **"Continue"**. 
...
Results are organized into 5 sections:
...
- Disease Carrier Status: This section presents the recessive disease that would be potentially transmitted to offspring. These diseases are caused by both ClinVar and ACMG P/LP variants.
